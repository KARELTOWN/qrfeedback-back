...
const templates: NotificationTemplateInput[] = [
  { name: "auth-otp", label: "Code de vérification", emailTitle: "#purpose Opinbase", emailTemplate: "<p>Bonjour,</p><p>Votre code est :</p><p style=\"font-size:28px;font-weight:700;letter-spacing:4px\">#code</p><p>#resetMessage</p><p>Ce code expire dans #expiresIn.</p>", smsTitle: "Opinbase", smsTemplate: "#purpose : votre code est #code. Il expire dans #expiresIn.", emailVariables: vars("purpose", "code", "resetMessage", "expiresIn"), smsVariables: vars("purpose", "code", "expiresIn") },
  { name: "company-qr-code-ready", label: "QR code prêt", emailTitle: "Votre QR Code de collecte d’avis", emailTemplate: "<p>Bonjour #companyName,</p><p>Votre lien de collecte est prêt : <a href=\"#feedbackUrl\">#feedbackUrl</a>.</p><p>Vous recevrez les nouveaux avis par e-mail. Connectez-vous ensuite à Opinbase pour activer Telegram.</p>", smsTitle: "Opinbase", smsTemplate: "Bonjour #companyName, votre lien de collecte est prêt : #feedbackUrl", emailVariables: vars("companyName", "feedbackUrl"), smsVariables: vars("companyName", "feedbackUrl") },
  ...
  { name: "invoice-issued", label: "Facture", emailTitle: "Facture #invoiceNumber", emailTemplate: "<p>Bonjour #companyName,</p><p>Votre paiement a été confirmé.</p><p>Facture : <strong>#invoiceNumber</strong></p><p>Montant : #amountFcfa FCFA.</p><p>#passwordMessage</p>", smsTitle: "Facture Opinbase", smsTemplate: "Paiement confirmé. Facture #invoiceNumber, montant #amountFcfa FCFA.", emailVariables: vars("companyName", "invoiceNumber", "amountFcfa", "passwordMessage"), smsVariables: vars("invoiceNumber", "amountFcfa") },
  { name: "admin-password-reset", label: "Mot de passe généré", emailTitle: "Nouveau mot de passe Opinbase", emailTemplate: "<p>Bonjour,</p><p>Un nouveau mot de passe a été généré pour votre compte :</p><p style=\"font-size:20px;font-weight:700\">#password</p><p>Connectez-vous puis changez-le depuis vos réglages.</p>", smsTitle: "Mot de passe Opinbase", smsTemplate: "Votre nouveau mot de passe temporaire est : #password", emailVariables: vars("password"), smsVariables: vars("password") },
  ...
  { name: "account-status-changed", label: "Compte activé / désactivé", emailTitle: "#statusLabel Opinbase", emailTemplate: "<p>Bonjour,</p><p>Votre compte Opinbase vient d'être <strong>#statusLabel</strong> par un administrateur.</p><p>#statusMessage</p>", smsTitle: "Opinbase", smsTemplate: "Votre compte Opinbase vient d'être #statusLabel. #statusMessage", emailVariables: vars("statusLabel", "statusMessage"), smsVariables: vars("statusLabel", "statusMessage") },
  { name: "review-client-auto-reply", label: "Réponse automatique au client", emailTitle: "Réponse de #companyName à votre avis", emailTemplate: "<p>Bonjour,</p><p>#replyBody</p><p style=\"margin-top:24px;color:#64748b;font-size:13px\">Réponse automatique de #companyName suite à votre avis.</p>", smsTitle: "#companyName", smsTemplate: "#replyBody", emailVariables: vars("companyName", "replyBody"), smsVariables: vars("companyName", "replyBody") },
];
